...
\item Advancement of physical models is in need of 3D information of the coronal fundamental parameters ${\bf B}, N_e, T_e$.
\end{itemize}
\vspace{0.35cm}
\azul{\bf Tomography}\\
\vspace{0.15cm}
...
%---------------------------------
\frame{
\titulo{DEMT tomography and K-cor tomography}
\footnotesize
Ecuaciones
...
\titulo{Results}
\footnotesize
Mapas de Ne a 2 alturas para ambos instrumentos
