...
of the Solar Corona: First Steps}
\author[D. Lloveras]
...
\salto
{\bf Second Binational AAA-SOCHIAS \textbar \ October-2018 \textbar \ La Serena, Chile}
\end{center}
  }
...
\begin{itemize}
\item 
\azul{Corona-K:} Thomson scattering of photospheric  \azul{white light (WL)}. Data gathered with WL coronographs.
...
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{new_figs/orbits_sdo2.jpg}}
\frame{
...
Two 1AU orbits behind and ahead Earth.
\salto
%\item
Atmospheric Imaging Assembly {\bf (AIA)}\\ 
Solar Dynamics Observatory {\bf(SDO)}\\ 
Geosynchronic orbit around Earth.
\salto
%The COronal Solar Magnetism Observatory {\bf (COSMO)}\\
K-coronagraph {\bf (K-Cor)}\\
Mauna Loa Solar Observatory {\bf(MLSO)}, Hawaii.
%\end{itemize}
\end{center}
\vspace{-0.5cm}
...
\end{center}
(Lloveras et al. 2017) $\rightarrow$ Systematic incertainties in DEMT results $\sim 10 \%$
}
%---------------------------------
\begin{comment}
\frame{
...
%---------------------------------
\frame{
\titulo{Multi-Instrument Tomography: First Results}
\vspace{-.2cm}
\footnotesize
\begin{center}
