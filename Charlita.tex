...
\vspace*{-0.75 cm}
\title[3D Solar Corona]{\bf Estudio Comparativo de M\'inimos Solares con Telescopios EUV}
\author[D. Lloveras]
       {{\bf Diego G. Lloveras}\inst{1}\\
       \vskip 0.1cm
       {
       A.M. Vásquez \inst{1},F. Nuevo\inst{1} y R.A. Frazin\inst{2}
       }
      % \\
       }
  \institute[IAFE]
...
%  \vspace{-0.25cm}
  \begin{center}
\framebox{\includegraphics[height=0.15\linewidth]{figuras/logo_IAFE.eps}}
%\framebox{\includegraphics[height=0.1\linewidth]{logo_LMSAL.eps}}
\framebox{\includegraphics[height=0.15\linewidth]{figuras/logo_AOSS.eps}}
\salto
{\bf AAA \textbar \ September-2016 \textbar \ San Juan}
\end{center}
  }
...
\frame{
\titulo{La Corona y la relación Sol-Tierra}
\scriptsize
\framebox{\includegraphics[width=\linewidth]{figuras/Sun-Earth.eps}}
\begin{center}
...
\vspace{0.55cm}
\begin{center}
{\includegraphics[width=0.9\textwidth]{figuras/SolarStructure.eps}}
\end{center}
...
\item Transition Region (Espesor 100 km)
\item Corona (T $\approx 1-10$\, MK, $n \approx 10^{10-7}\ {\rm cm}^{-3}$)
\end{itemize}
\begin{center}
{\includegraphics[width=0.675\textheight]{figuras/region_transicion_fede.eps}}
\end{center}
\end{columns}
}
%---------------------------------------------------------------------------
...
%Images are thus 2D projections of the underlying 3D emitting structure.
% \salto
...
%Advancement of physical models is in need of 3D information of the coronal fundamental parameters ${\bf B}, N_e, T_e$.
\end{itemize}
\vspace{0.35cm}
\begin{columns}
\column{0.5\textwidth}
\begin{center}
{\includegraphics[height=0.9\textwidth]{figuras/aia_193_fullsun.eps}}
%\azul{\bf Stereoscopy}
