...
\vspace*{-0.75 cm}
\title[3D Solar Corona]{\bf Distribution of Iron Abundance in the Solar Corona from Multi-wavelength Tomography}
\author[D. Lloveras]
...
%  \and
%  \inst{2}
%  Lockheed Martin Solar \& Astrophysics Lab \textcolor{blue}{(LMSAL)}\\
%  Advanced Technology Center, Palo Alto - California, EEUU
  \and
  \inst{2}
  Dept. of Atmospheric, Oceanic and Space Sciences \textcolor{blue}{(AOSS)}\\
  University of Michigan, Ann Arbor - Michigan, EEUU
  \salto
%  \vspace{-0.25cm}
  \begin{center}
...
\framebox{\includegraphics[height=0.15\linewidth]{new_figs/logo_AOSS.eps}}
\salto
...
\vspace{-1.cm}
\footnotesize
\includegraphics[height=0.34\textheight]{new_figs/map_kcor_1105.eps} 
\includegraphics[height=0.34\textheight]{new_figs/map_aia_1105.eps}\\
...
%--------------------------------------------------
\frame{
\includegraphics[height=0.23\textwidth]{new_figs/Average_Radial_Profiles_KCOR-Tom_vs_DEMT_CR2198_Hh_reduced_overreg-Open-region_N.eps}
\includegraphics[height=0.28\textwidth]{new_figs/comparison_KCOR-Tom_vs_DEMT_CR2198_Hh_reduced_overreg-Open-region_N_range1105-1155_Rsun.eps}\\
\includegraphics[height=0.23\textwidth]{new_figs/Average_Radial_Profiles_KCOR-Tom_vs_DEMT_CR2198_Hh_reduced_overreg-Quiet-region2.eps}
\includegraphics[height=0.28\textwidth]{new_figs/comparison_KCOR-Tom_vs_DEMT_CR2198_Hh_reduced_overreg-Quiet-region2_range1105-1195_Rsun.eps}
}
%-----------------------------
...
\column{0.5\textwidth}
\begin{center}
\figu{\includegraphics[width=0.85\textwidth,angle=-90]{new_figs/fig3_1.eps}}
\end{center}
\column{0.5\textwidth}
\begin{center}
\figu{\includegraphics[width=0.85\textwidth,angle=-90]{new_figs/fig3_2.eps}}
\end{center}
\end{columns}
\end{center}
\begin{itemize}
...
\setbeamercolor{frametitle}{fg=white}
\usebeamercolor[fg]{normal text}
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{figuras/orbits.eps}}
\frame{
